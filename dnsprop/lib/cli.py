...
def cli_parser():
    parser = argparse.ArgumentParser(add_help=False, description='''
        DNS proprogration is offten a pain to track and maintain.\n
        It is offten needed to to ensure that US wide that the current record is \n
    ...
    parser.add_argument(
        "-D", metavar="domain.com", help="set domain to query dns for")
    parser.add_argument(
